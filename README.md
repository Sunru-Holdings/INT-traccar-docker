...
## Available tags:
#### 5.X
- **5.10.s3-alpine**, **5-alpine**, **alpine**, **5.10.s3**, **5**, **latest** ![](https://img.shields.io/docker/image-size/traccar/traccar/5.10.s3-alpine)
- **5.10.s3-debian**, **5-debian**, **debian** ![](https://img.shields.io/docker/image-size/traccar/traccar/5.10.s3-debian)
- **5.10.s3-ubuntu**, **5-ubuntu**, **ubuntu** ![](https://img.shields.io/docker/image-size/traccar/traccar/5.10.s3-ubuntu)
- _..._
